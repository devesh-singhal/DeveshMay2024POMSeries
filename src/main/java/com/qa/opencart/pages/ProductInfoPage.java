...
public class ProductInfoPage {
	...
	private static By productHeader = By.tagName("h1") ;
	...
	public static String getProductHeader() {
...
//	Availability: In Stock
	...
	//£1,225.00
	//Ex Tax: £1,225.00
	private void getProductPriceDeta() {
	 ...
	 public int getProductImagesCount() {
		int imagesCount =   eleUtil.waitForElementsPresence(productImages, AppConstants.DEFAULT_MEDIUM_TIME_OUT) .size();		   
		   System.out.println("The Images Count is: " + imagesCount);
		   return imagesCount ;
