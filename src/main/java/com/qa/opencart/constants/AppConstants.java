...
public class AppConstants {
	...
	public static final int DEFAULT_SHORT_TIME_OUT = 6;
...
public static final List<String> EXPECTED_ACCOUNTSPAGE_HEADERS_LIST = List.of("My Account", "My Orders", "My Affiliate Account", "Newsletter");
